...
void loop() { //Rutina para escribir las instrucciones a realizar infinitamente
  ...
  menu=map(menu,0,1023,0,11);//Divide el voltaje guardado en la variable menu y lo divide en 11 partes

  switch(menu){ //Condicional switch que secciona programación por casos
                //depende de la variable "menu"
    case 0:
    lcd.clear();
    lcd.setCursor(2,0);
    lcd.print("caso 0"); 
    delay(100);
      break;
    case 1: //Cuando la variable "menu" equivale a 1, ingresa en este caso
    lcd.clear();
    lcd.setCursor(2,0);
    lcd.print("caso 1"); 
    delay(100);
    ...
    delay(100); 
      break;
    case 3: //Cuando la variable "menu" equivale a 3, ingresa en este caso
    lcd.clear();
    lcd.setCursor(2,0);
    lcd.print("caso 3");
    delay(100); 
